            ...
            {hasCaloriesData && caloriesLineData.length >= 1 ? (
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={caloriesLineData} margin={{ top: 2, right: 4, left: -8, bottom: 0 }}>
                  ...
                  <Tooltip contentStyle={{ background: "#18181b", border: "1px solid rgba(255,255,255,0.1)" }} formatter={(v: number | undefined, n: string): [string, string] => [`${v ?? 0} kcal`, n]} />
            ...
            {hasMacrosData && macrosLineData.length >= 1 ? (
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={macrosLineData} margin={{ top: 2, right: 4, left: -8, bottom: 0 }}>
                  ...
                  <Tooltip contentStyle={{ background: "#18181b", border: "1px solid rgba(255,255,255,0.1)" }} formatter={(v: number | undefined, n: string): [string, string] => [`${v ?? 0} g`, n]} />
            ...
            {weightData.length >= 1 ? (
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={weightData} margin={{ top: 2, right: 4, left: -8, bottom: 0 }}>
                  ...
                  <XAxis dataKey="day" tick={{ fontSize: 9, fill: "rgba(255,255,255,0.6)" }} stroke="rgba(255,255,255,0.15)" />
                  <YAxis tick={{ fontSize: 9, fill: "rgba(255,255,255,0.6)" }} stroke="rgba(255,255,255,0.15)" width={28} tickFormatter={(v: number | undefined) => `${v ?? 0}`} />
                  <Tooltip contentStyle={{ background: "#18181b", border: "1px solid rgba(255,255,255,0.1)" }} formatter={(v: number | undefined, n: string): [string, string] => [`${v ?? 0} kg`, n]} />
